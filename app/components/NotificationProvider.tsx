...
interface Notification {
  ...
  title: string;
  message?: string;
  duration?: number; // Auto-hide after this many ms, 0 for no auto-hide
}
      ...
      <div className="flex items-start">
        ...
        {notification.type !== 'loading' && (
          <div className="ml-4 flex-shrink-0">
            <button
              onClick={onClose}
              className={`inline-flex rounded-md p-1.5 hover:bg-black/5 dark:hover:bg-white/5 ${getTextColor()}`}
            >
